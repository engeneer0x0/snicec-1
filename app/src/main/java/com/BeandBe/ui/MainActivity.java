...
import com.BeandBe.ui.fragment.TabsAdapter;
...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		webForum = (WebView) findViewById(R.id.webview);	
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		webDonation=(WebView)findViewById(R.id.WebDonation); 
		//webDonation.getUrl();
		webForum=(WebView)findViewById(R.id.webview);
		//webForum.getUrl();
		Log.e("fragment", "this is "+ getVisibleFragment());
		
		
		if(getVisibleFragment() == getSupportFragmentManager().getFragments().get(0)){
		
			if ((keyCode == KeyEvent.KEYCODE_BACK) && webForum.canGoBack()) {
	    	  webForum.goBack();
	    	  Log.e("fr","this ="+getVisibleFragment());
	    	return true;
	         }
		}
		
		if(getVisibleFragment() == getSupportFragmentManager().getFragments().get(2)){
		
			if ((keyCode == KeyEvent.KEYCODE_BACK) && webDonation.canGoBack()) {
	    	  webDonation.goBack();
	    	  Log.e("fr","this ="+getVisibleFragment());
	    	return true;
	        }
